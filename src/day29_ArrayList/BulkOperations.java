...
public class BulkOperations {
    public static void main(String[] args) {
        ...
        ArrayList<String> jobTittles = new ArrayList<>();
        jobTittles.addAll(Arrays.asList("QA","SDET","Developer","QA","SDET","Scrum Master","BA","BA"));

        jobTittles.retainAll(Arrays.asList("QA","SDET"));
        System.out.println(jobTittles);
       ...
       boolean r3 = nums.containsAll(Arrays.asList(3,5,1000));
