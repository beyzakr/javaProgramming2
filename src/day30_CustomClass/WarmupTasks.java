...
public class WarmupTasks {
    public static void main(String[] args) {
        ...
        letters.removeIf(p-> !Character.isLetter(p));  //remove the characters are not letters
        System.out.println("letters = " + letters);

        ArrayList<Character> digits = new ArrayList<>(chars);//add all the characters
        digits.removeIf(p-> !Character.isDigit(p)); //remove the characters are not digits
