...
public class BreakfastTasks {
    public static void main(String[] args) {
        ...
        String[] emails = {"josh@gmail.com","Jim@yahoo@gmail.com","Elminur@cydeo.com","Gulsen@gmail.com"};
  ...
  public static void initials(String firstName, String lastName){
    ...
    public static void nameOfDay(int number){
        ...
        if (number>=1 && number<=7){
            name = (number==1)?"Mon" :(number==2)?"Tue" :(number==3)?"Wed" :(number==4)?"Thursday" :(number==5)?"Fri"
                    :(number==6)?"Sat" : "Sun";
        }
        else{
            name="Invalid";
