...
public class LogIn {
    public static void main(String[] args) {
        ...
        if (u.equals("Cydeo") && p.equals("Cydeo123")) { //if credentials are valid
            ...
            while (!(u.equals("Cydeo") && p.equals("Cydeo123")) && attempts > 0) { // when the credentials are invalid, and user has attempts to reenter
               if(attempts == 1){
                   System.out.println("THIS YOUR LAST CHANCE");
               }
